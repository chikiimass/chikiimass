...
import { COLLECTION_SLUG_EPISODES, COLLECTION_SLUG_LIVESTREAMS, COLLECTION_SLUG_MOVIES, COLLECTION_SLUG_PODCASTS, COLLECTION_SLUG_RADIO, COLLECTION_SLUG_SERIES, COLLECTION_SLUG_SESSIONS, COLLECTION_SLUG_USER } from './config'
...
export const users: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'watchHistory', type: 'array', fields: [{ name: 'content', type: 'relationship', relationTo: [COLLECTION_SLUG_MOVIES, COLLECTION_SLUG_SERIES, COLLECTION_SLUG_EPISODES, COLLECTION_SLUG_LIVESTREAMS, COLLECTION_SLUG_PODCASTS, COLLECTION_SLUG_RADIO] }] },
    { name: 'watchlist', type: 'relationship', relationTo: [COLLECTION_SLUG_MOVIES, COLLECTION_SLUG_SERIES, COLLECTION_SLUG_EPISODES], hasMany: true },
  ]
} as const
